...
I have seen a sentiment among my artist friends that AI will or already has replaced them. The AI technologies currently making waves will deeply impact every information and creative sector job, if you work on a computer your job is going to change as it has changed with smart phones, the internet, the computer, and every other major technological revolution of our lifetimes. At the top here I’d like to separate art loosely into two categories, the first being fine art and the second being commercial. AI cannot replace fine art. When we create work for ourselves, we do it because we must, children draw, and I still play music.   
